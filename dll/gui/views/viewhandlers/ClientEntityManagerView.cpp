...
void ClientEntityManagerView::RenderProperties(ClientEntityManager* pEntity)
{
	...
	if (BeginFullPropertyTable("ClientEntityManager"))
	{
		...
		RenderPropertyWithHex("EntityManager", &pEntity->unk_58);
		RenderPropertyWithHex("world_scene_manager", &pEntity->unk_59);
		RenderPropertyWithHex("world_collision_manager", &pEntity->unk_60);
		RenderPropertyWithHex("world_collision_helper", &pEntity->unk_61);
		RenderPropertyWithHex("path_manager", &pEntity->unk_62);
		RenderPropertyWithHex("unit_finder", &pEntity->unk_63);
		RenderPropertyWithHex("gcobject_0", &pEntity->unk_64);
		RenderPropertyWithHex("gcobject_1", &pEntity->unk_65);
		RenderPropertyWithHex("worldmap", &pEntity->unk_66);
		RenderPropertyWithHex("zonedef", &pEntity->unk_67);
