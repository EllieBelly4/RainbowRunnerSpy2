...
```cpp
Begin("MyWindow");
Button("ListItemOK");          // Label = "ListItemOK",     ID = hash of ("MyWindow", "ListItemOK")
...
{
    Button("ListItemOK");      // Label = "ListItemOK",     ID = hash of ("MyWindow", "MyTreeNode", "ListItemOK")
    TreePop();
}
End();
```
- Two items labeled "ListItemOK" in different windows or different tree locations won't collide:
```cpp
Begin("MyFirstWindow");
Button("ListItemOK");          // Label = "ListItemOK",     ID = hash of ("MyFirstWindow", "ListItemOK")
End();
Begin("MyOtherWindow");
Button("ListItemOK");          // Label = "ListItemOK",     ID = hash of ("MyOtherWindow", "ListItemOK")
End();
```
...
```cpp
Button("ListItemOK");
Button("ListItemOK");          // ID collision! Interacting with either button will trigger the first one.
```
...
// Draw a 3 pixel thick colourYellow line
