...
// [Main] 3: TableSaveSettings()               When table GameClientStateManagerProperties are modified, serialize Table data into bound or new TableSettings, mark .ini as dirty.
